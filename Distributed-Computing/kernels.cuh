...
__global__ void prescan_arbitrary(int *g_odata, int *g_idata, int n, int powerOfTwo, bool bcao);

__global__ void prescan_large(int *g_odata, int *g_idata, int n, int* sums, bool bcao);
